...
const zhCN: Record<string, string> = {
  ...
  'TMDB metadata retention expired': 'TMDB 元数据保留期已到',
  'TMDB metadata could not be revalidated within 180 days. Provider-owned metadata and cached data were cleared, and the item is ready to be matched again.':
    'TMDB 元数据在 180 天内未能重新验证。由 TMDB 提供的元数据和缓存已清除，此条目现在可以重新匹配。',
  Type: '类型',
  Result: '结果',
  Time: '时间',
  Target: '目标',
  ...
  Scan: '扫描',
  Completed: '完成',
  'Completed with issues': '完成，但存在问题',
  Information: '信息',
  'Mova server': 'Mova 服务',
  ...
  'Filter media': '筛选媒体',
  Reset: '重置',
  'Search title or original title': '搜索标题或原名',
  'All years': '全部年份',
  'Release year': '发行年份',
  'All media': '全部媒体',
  Category: '分类',
  ...
  'Needs review': '待复核',
  '{{count}} active filters': '{{count}} 个筛选条件已生效',
  'Enter a valid year.': '请输入有效年份。',
  'Sort media': '媒体排序',
  'Sort method': '排序方式',
  'Sort direction': '排序方向',
  Ascending: '升序',
  Descending: '降序',
  Clear: '清除',
  'No items match these filters': '没有符合筛选条件的内容',
  'Try a different media type, title, or year, or clear the filters.':
    '请尝试其他媒体类型、标题或年份，或者清除筛选条件。',
  'Library pages': '媒体库分页',
  Previous: '上一页',
  Next: '下一页',
  'Page {{page}} of {{total}}': '第 {{page}} / {{total}} 页',
  'Scanning library': '正在扫描媒体库',
  'Scanning items': '扫描中的条目',
