...
const zhCN: Record<string, string> = {
  ...
  'No matching media found.': '没有找到匹配的媒体。',
  ...
  '{{count}} search results': '{{count}} 个搜索结果',
  ...
  'Failed to load watch history': '加载观看历史失败',
  'No recently watched media yet.': '还没有最近观看内容。',
  'Start watching something and it will appear here.': '开始播放后，内容会显示在这里。',
  Watched: '已看完',
  '{{count}}% watched': '已观看 {{count}}%',
  'Last watched {{value}}': '最近观看：{{value}}',
