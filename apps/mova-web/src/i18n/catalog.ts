...
const zhCN: Record<string, string> = {
  ...
  'Library Hub': '媒体库中心',
  'All Libraries': '全部媒体库',
  'Failed to load recently added media': '加载最新添加失败',
  'Recently Added by Library': '按库最新添加',
  'Loading recently added media': '正在加载最新添加',
  'No recently added media yet.': '还没有最新添加内容。',
