...
export const MediaPlayerPage = () => {
  ...
  const intro =
    ...
    typeof (currentEpisode.intro_end_seconds ?? currentSeason?.intro_end_seconds) === 'number'
      ? {
          startSeconds: (currentEpisode.intro_start_seconds ??
            currentSeason?.intro_start_seconds) as number,
          endSeconds: (currentEpisode.intro_end_seconds ??
            currentSeason?.intro_end_seconds) as number,
        }
      : null
