...
export const apiEndpointGroups: ApiEndpointGroup[] = [
  ...
  },
  {
    ...
    endpoints: [
      ...
      { method: 'POST', path: '/api/libraries', description: '创建媒体库（管理员）' },
      { method: 'GET', path: '/api/libraries/{id}', description: '查询单个媒体库详情' },
      { method: 'PATCH', path: '/api/libraries/{id}', description: '更新媒体库基础配置（管理员）' },
      { method: 'DELETE', path: '/api/libraries/{id}', description: '删除媒体库（管理员）' },
      { method: 'GET', path: '/api/libraries/{id}/media-items', description: '查询媒体库下的媒体条目列表' },
      { method: 'GET', path: '/api/libraries/{id}/scan-jobs', description: '查询媒体库扫描历史（管理员）' },
      { method: 'GET', path: '/api/libraries/{id}/scan-jobs/{scan_job_id}', description: '查询单个扫描任务状态（管理员）' },
      { method: 'POST', path: '/api/libraries/{id}/scan', description: '触发异步扫描（管理员）' },
  ...
  },
  {
    ...
    endpoints: [
      ...
      { method: 'POST', path: '/api/media-items/{id}/refresh-metadata', description: '手动重拉单个媒体条目元数据（管理员）' },
