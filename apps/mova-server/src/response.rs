...
pub struct LibraryLastScanResponse {
    ...
    pub local_analyzed_files: i32,
    pub local_committed_files: i32,
    pub remote_completed_files: i32,
...
#[derive(Debug, Serialize)]
pub struct RecentlyAddedLibraryMediaItemsResponse {
...
impl RecentlyAddedLibraryMediaItemsResponse {
    pub fn from_domain(
...
impl MediaFileResponse {
    pub fn from_domain(media_file: MediaFile, offset: UtcOffset) -> Self {
        Self {
            ...
            technical_tags: media_file.technical_tags,
...
impl ScanJobResponse {
    ...
    pub fn from_realtime(scan_job: ScanJob, phase: Option<String>, offset: UtcOffset) -> Self {
        Self {
            ...
            local_analyzed_files: scan_job.local_analyzed_files,
            local_committed_files: scan_job.local_committed_files,
            remote_completed_files: scan_job.remote_completed_files,
            progress_percent: scan_job.progress_percent,
...
impl ScanItemProgressResponse {
    pub fn from_domain(item: ScanJobItemProgressUpdate) -> Self {
        Self {
            ...
            remote_media_type: item.remote_media_type,
...
fn public_season_asset_path(
    ...
    if stored_path.is_empty() || is_generated_episode_still_path(stored_path) {
        return None;
    }
...
mod tests {
    ...
    #[test]
    fn public_season_asset_path_hides_generated_episode_stills() {
        assert_eq!(
            public_season_asset_path(
                7,
                Some("/cache/generated/episode-stills/s01e01.jpg"),
                "backdrop",
                OffsetDateTime::UNIX_EPOCH,
            ),
            None
