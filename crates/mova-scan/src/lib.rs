...
pub use discover::{
    ...
    inspect_media_file_inventory_within_root_with_cancel_and_subtitle_index,
...
pub struct DiscoveredMediaFile {
    ...
    pub series_local_nfo: Option<LocalNfoMetadata>,
    pub invalid_local_nfo_source_path: Option<PathBuf>,
    pub invalid_series_local_nfo_source_path: Option<PathBuf>,
    pub local_nfo_is_selected: bool,
    pub series_local_nfo_is_selected: bool,
    ...
    pub episode_premiere_date: Option<String>,
