...
const translations: Record<string, string> = {
  ...
  '原生 macOS 客户端，更优雅的体验。': 'A native macOS client with a more elegant experience.',
  '前往 Mac App Store 安装': 'Install from the Mac App Store',
  '原生客户端暂不支持 Android': 'The native client does not currently support Android',
  ...
  积极开发中: 'Actively in development',
  网页端: 'Web',
  '在浏览器中随时访问，无需安装。': 'Access it anytime in your browser, with nothing to install.',
  'macOS 端': 'macOS',
  手机端: 'Phone',
  '积极开发中，敬请期待。': 'Actively in development. Stay tuned.',
  'Pad 端': 'Pad',
